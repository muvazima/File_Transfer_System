...
serverName = input('Enter server IP[127.0.0.1]: ') or "127.0.0.1"
serverPort = int(input('Enter port number[3500]: ') or 3500)
authServerPort = int(input('Enter auth Server port: [2000]: ') or 2000)
...
def main():
    ...
    while True:
        ...
        if sentence == 'GET':
            ...
            f = open("fromServer_" + fileName, "wb")
